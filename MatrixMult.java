// This code implements the algorithms for the Matrix Chain Multiplication.
// 1. save it in a file MatrixMult.java 
// 2. compile with instruction javac MatrixMult.java
// 3. run with instruction java MatrixMult p_0 p_1 ... p_n
// where p_0..p_n are the matrix dimensions (positive numbers)
// For example, the command string for the example in the book would be
// java MatrixMult 30 35 15 5 10 20 25   
